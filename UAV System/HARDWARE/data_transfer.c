...
float Tool_Thr_value = 0;
float Rol_value = 0;
float pit_value = 0;
u8 fly_ready = 0;
extern float shangchu;
...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser)
	{
		...
		ANO_DT_Send_Senser(mpu6050.Acc.x,mpu6050.Acc.y,mpu6050.Acc.z,
											 ...
											 shangchu,Speed_Pos.Y_Speed,height_ctrl_out,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid2 = 0;
		ANO_DT_Send_PID(2,ctrl_1.PID[ALT].kp,ctrl_1.PID[ALT].ki,ctrl_1.PID[ALT].kd,
											Tool_Thr_value,Rol_value,pit_value,
											0,0,0);
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid3)
...
void ANO_DT_Data_Receive_Anl(u8 *data_buf,u8 num)
{
    ...
    {
        Camera_Pos.Speed_Y.kp  = 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
        Camera_Pos.Speed_Y.ki  = 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
        Camera_Pos.Speed_Y.kd  = 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
...
//        ctrl_1.PID[PIDYAW].kd 	= 0.001*( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
    ...
    {
//        ultra_pid.Kp 	= 0.001*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
//        ultra_pid.Ki 	= 0.001*( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
//        ultra_pid.Kd 	= 0.001*( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
//        Tool_Thr_value 	= ( (vs16)(*(data_buf+10)<<8)|*(data_buf+11) );
//        Rol_value 	= 0.001*( (vs16)(*(data_buf+12)<<8)|*(data_buf+13) );
//        pit_value 	= 0.001*( (vs16)(*(data_buf+14)<<8)|*(data_buf+15) );
        fly_ready	  = ( (vs16)(*(data_buf+16)<<8)|*(data_buf+17) );
       ChooseRise_Land	= ((vs16)(*(data_buf+18)<<8)|*(data_buf+19) );
